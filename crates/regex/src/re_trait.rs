...
#[cfg_attr(test, ::mutagen::mutate)] impl Locations {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'c> Iterator for SubCapturesPosIter<'c> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'t, R> Matches<'t, R>
where
    R: RegularExpression,
    R::Text: 't,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'t, R> Iterator for Matches<'t, R>
where
    R: RegularExpression,
    R::Text: 't + AsRef<[u8]>,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'t, R> CaptureMatches<'t, R>
where
    R: RegularExpression,
    R::Text: 't,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'t, R> Iterator for CaptureMatches<'t, R>
where
    R: RegularExpression,
    R::Text: 't + AsRef<[u8]>,
{
