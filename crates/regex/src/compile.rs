...
#[cfg_attr(test, ::mutagen::mutate)] impl Compiler {
...
#[cfg_attr(test, ::mutagen::mutate)] impl MaybeInst {
...
#[cfg_attr(test, ::mutagen::mutate)] impl InstHole {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a, 'b> CompileClass<'a, 'b> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl SuffixCache {
...
#[cfg_attr(test, ::mutagen::mutate)] impl ByteClassSet {
    fn new() -> Self {
...
#[cfg_attr(test, ::mutagen::mutate)] fn u32_to_usize(n: u32) -> usize {
