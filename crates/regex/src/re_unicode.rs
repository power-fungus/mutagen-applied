...
#[cfg_attr(test, ::mutagen::mutate)] impl<'t> Match<'t> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'t> From<Match<'t>> for &'t str {
...
#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Display for Regex {
...
#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Debug for Regex {
    /// Shows the original regular expression.
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
...
#[doc(hidden)]
#[cfg_attr(test, ::mutagen::mutate)] impl From<Exec> for Regex {
    fn from(exec: Exec) -> Regex {
        Regex(exec)
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl FromStr for Regex {
    type Err = Error;
...
#[cfg_attr(test, ::mutagen::mutate)] impl Regex {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'r> Iterator for CaptureNames<'r> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'r, 't> Iterator for Split<'r, 't> {
    type Item = &'t str;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'r, 't> Iterator for SplitN<'r, 't> {
    type Item = &'t str;
...
#[cfg_attr(test, ::mutagen::mutate)] impl CaptureLocations {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'t> Captures<'t> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'t> fmt::Debug for Captures<'t> {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'c, 't> fmt::Debug for CapturesDebug<'c, 't> {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'t> Index<usize> for Captures<'t> {
    type Output = str;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'t, 'i> Index<&'i str> for Captures<'t> {
    type Output = str;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'c, 't> Iterator for SubCaptureMatches<'c, 't> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'r, 't> Iterator for CaptureMatches<'r, 't> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'r, 't> Iterator for Matches<'r, 't> {
    type Item = Match<'t>;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a, R: Replacer + ?Sized + 'a> Replacer for ReplacerRef<'a, R> {
    fn replace_append(&mut self, caps: &Captures, dst: &mut String) {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a> Replacer for &'a str {
    fn replace_append(&mut self, caps: &Captures, dst: &mut String) {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<F, T> Replacer for F
where
    F: FnMut(&Captures) -> T,
    T: AsRef<str>,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'t> Replacer for NoExpand<'t> {
