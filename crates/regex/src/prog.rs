...
#[cfg_attr(test, ::mutagen::mutate)] impl Program {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Deref for Program {
    type Target = [Inst];
...
#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Debug for Program {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a> IntoIterator for &'a Program {
    type Item = &'a Inst;
...
#[cfg_attr(test, ::mutagen::mutate)] impl Inst {
...
#[cfg_attr(test, ::mutagen::mutate)] impl InstRanges {
...
#[cfg_attr(test, ::mutagen::mutate)] impl InstBytes {
