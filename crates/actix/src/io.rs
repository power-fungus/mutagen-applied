...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: AsyncWrite, E: From<io::Error>> Clone for UnsafeWriter<T, E> {
    fn clone(&self) -> Self {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: AsyncWrite, E: From<io::Error> + 'static> Writer<T, E> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: 'static, E: 'static, A> ActorFuture for WriterFut<T, E, A>
where
    T: AsyncWrite,
    E: From<io::Error>,
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T, E, A> ActorFuture for WriterDrain<T, E, A>
where
    T: AsyncWrite,
    E: From<io::Error>,
    A: Actor,
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: AsyncWrite, U: Encoder> FramedWrite<T, U> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: AsyncWrite, U: Encoder> Drop for FramedWrite<T, U> {
    fn drop(&mut self) {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<S: Sink + 'static> SinkWrite<S> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<S, A> ActorFuture for SinkWriteFuture<S, A>
where
    S: Sink,
