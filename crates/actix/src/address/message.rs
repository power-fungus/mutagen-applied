...
#[cfg_attr(test, ::mutagen::mutate)] impl<A, M> Request<A, M>
where
    A: Handler<M>,
    A::Context: ToEnvelope<A, M>,
    M: Message,
...
#[cfg_attr(test, ::mutagen::mutate)] impl<A, M> Future for Request<A, M>
where
    A: Handler<M>,
    A::Context: ToEnvelope<A, M>,
    M: Message + Send,
...
#[cfg_attr(test, ::mutagen::mutate)] impl<M> RecipientRequest<M>
where
    M: Message + Send + 'static,
    M::Result: Send,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<M> Future for RecipientRequest<M>
where
    M: Message + Send + 'static,
    M::Result: Send,
{
