...
#[cfg_attr(test, ::mutagen::mutate)] impl<A: Actor> fmt::Debug for AddressSender<A> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<A: Actor> fmt::Debug for WeakAddressSender<A> {
    fn fmt(&self, fmt: &mut fmt::Formatter) -> fmt::Result {
...
#[cfg_attr(test, ::mutagen::mutate)] impl SenderTask {
    fn new() -> Self {
        SenderTask {
            task: None,
            is_parked: false,
...
//
//
#[cfg_attr(test, ::mutagen::mutate)] impl<A: Actor> AddressSender<A> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<A, M> Sender<M> for AddressSender<A>
where
    A: Handler<M>,
    A::Context: ToEnvelope<A, M>,
    M::Result: Send,
...
#[cfg_attr(test, ::mutagen::mutate)] impl<A: Actor> Clone for AddressSender<A> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<A: Actor> Drop for AddressSender<A> {
    fn drop(&mut self) {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<A: Actor> PartialEq for AddressSender<A> {
    fn eq(&self, other: &Self) -> bool {
        Arc::ptr_eq(&self.inner, &other.inner)
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl<A: Actor> Eq for AddressSender<A> {}

#[cfg_attr(test, ::mutagen::mutate)] impl<A: Actor> Hash for AddressSender<A> {
...
//
//
#[cfg_attr(test, ::mutagen::mutate)] impl<A: Actor> WeakAddressSender<A> {
...
//
//
#[cfg_attr(test, ::mutagen::mutate)] impl<A: Actor> AddressSenderProducer<A> {
...
//
//
#[cfg_attr(test, ::mutagen::mutate)] impl<A: Actor> AddressReceiver<A> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<A: Actor> Stream for AddressReceiver<A> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<A: Actor> Drop for AddressReceiver<A> {
    fn drop(&mut self) {
        // close
        let mut curr = self.inner.state.load(SeqCst);
        loop {
...
//
//
#[cfg_attr(test, ::mutagen::mutate)] impl<A: Actor> Inner<A> {
...
//
//
#[cfg_attr(test, ::mutagen::mutate)] fn decode_state(num: usize) -> State {
    State {
...
#[cfg_attr(test, ::mutagen::mutate)] fn encode_state(state: &State) -> usize {
