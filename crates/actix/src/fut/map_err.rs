...
#[cfg_attr(test, ::mutagen::mutate)] impl<U, A, F> ActorFuture for MapErr<A, F>
where
    A: ActorFuture,
...
#[cfg_attr(test, ::mutagen::mutate)] impl<A> DropErr<A>
where
    A: ActorFuture,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<A> ActorFuture for DropErr<A>
where
    A: ActorFuture,
{
    type Item = A::Item;
