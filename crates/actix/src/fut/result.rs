...
#[cfg_attr(test, ::mutagen::mutate)] impl<T, E, A> ActorFuture for FutureResult<T, E, A>
where
    A: Actor,
{
    type Item = T;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T, E, A> From<Result<T, E>> for FutureResult<T, E, A> {
