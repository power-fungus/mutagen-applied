...
#[cfg_attr(test, ::mutagen::mutate)] impl Route {
...
#[cfg_attr(test, ::mutagen::mutate)] impl NewService for Route {
    type Config = ();
...
#[cfg_attr(test, ::mutagen::mutate)] impl Future for CreateRouteService {
...
#[cfg_attr(test, ::mutagen::mutate)] impl RouteService {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Service for RouteService {
    type Request = ServiceRequest;
    type Response = ServiceResponse;
    type Error = Error;
    type Future = Either<
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> RouteNewService<T>
where
    T: NewService<
        Config = (),
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> NewService for RouteNewService<T>
where
    T: NewService<
        Config = (),
        Request = ServiceRequest,
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> Service for RouteServiceWrapper<T>
where
    T::Future: 'static,
    T: Service<
        Request = ServiceRequest,
