...
#[cfg_attr(test, ::mutagen::mutate)] impl HttpRequest {
    #[inline]
    pub(crate) fn new(
        path: Path<Url>,
...
#[cfg_attr(test, ::mutagen::mutate)] impl HttpMessage for HttpRequest {
    type Stream = ();
...
#[cfg_attr(test, ::mutagen::mutate)] impl Drop for HttpRequest {
    fn drop(&mut self) {
...
/// }
/// ```
#[cfg_attr(test, ::mutagen::mutate)] impl FromRequest for HttpRequest {
    type Config = ();
    type Error = Error;
...
#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Debug for HttpRequest {
...
#[cfg_attr(test, ::mutagen::mutate)] impl HttpRequestPool {
