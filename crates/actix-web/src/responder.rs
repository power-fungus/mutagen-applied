...
#[cfg_attr(test, ::mutagen::mutate)] impl Responder for Response {
    type Error = Error;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> Responder for Option<T>
where
    T: Responder,
{
    type Error = T::Error;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T, E> Responder for Result<T, E>
where
    T: Responder,
    E: Into<Error>,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl Responder for ResponseBuilder {
    type Error = Error;
    type Future = FutureResult<Response, Error>;
...
#[cfg_attr(test, ::mutagen::mutate)] impl Responder for () {
    type Error = Error;
    type Future = FutureResult<Response, Error>;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> Responder for (T, StatusCode)
where
    T: Responder,
{
    type Error = T::Error;
...
#[cfg_attr(test, ::mutagen::mutate)] impl Responder for &'static str {
    type Error = Error;
    type Future = FutureResult<Response, Error>;
...
#[cfg_attr(test, ::mutagen::mutate)] impl Responder for &'static [u8] {
    type Error = Error;
    type Future = FutureResult<Response, Error>;
...
#[cfg_attr(test, ::mutagen::mutate)] impl Responder for String {
    type Error = Error;
    type Future = FutureResult<Response, Error>;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a> Responder for &'a String {
    type Error = Error;
    type Future = FutureResult<Response, Error>;
...
#[cfg_attr(test, ::mutagen::mutate)] impl Responder for Bytes {
    type Error = Error;
    type Future = FutureResult<Response, Error>;
...
#[cfg_attr(test, ::mutagen::mutate)] impl Responder for BytesMut {
    type Error = Error;
    type Future = FutureResult<Response, Error>;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: Responder> CustomResponder<T> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: Responder> Responder for CustomResponder<T> {
    type Error = T::Error;
    type Future = CustomResponderFut<T>;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: Responder> Future for CustomResponderFut<T> {
    type Item = Response;
    type Error = T::Error;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<A, B> Responder for Either<A, B>
where
    A: Responder,
    B: Responder,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<A, B> Future for EitherResponder<A, B>
where
    A: Future<Item = Response>,
    A::Error: Into<Error>,
    B: Future<Item = Response>,
...
#[cfg_attr(test, ::mutagen::mutate)] impl<I, E> Responder for Box<dyn Future<Item = I, Error = E>>
where
    I: Responder + 'static,
    E: Into<Error> + 'static,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> Responder for InternalError<T>
where
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> ResponseFuture<T> {
    pub fn new(fut: T) -> Self {
        ResponseFuture(fut)
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl<T> Future for ResponseFuture<T>
where
