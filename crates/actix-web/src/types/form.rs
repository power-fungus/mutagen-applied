...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> Form<T> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> ops::Deref for Form<T> {
    type Target = T;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> ops::DerefMut for Form<T> {
    fn deref_mut(&mut self) -> &mut T {
        &mut self.0
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl<T> FromRequest for Form<T>
where
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: fmt::Debug> fmt::Debug for Form<T> {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        self.0.fmt(f)
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl<T: fmt::Display> fmt::Display for Form<T> {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        self.0.fmt(f)
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl<T: Serialize> Responder for Form<T> {
    type Error = Error;
...
#[cfg_attr(test, ::mutagen::mutate)] impl FormConfig {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Default for FormConfig {
    fn default() -> Self {
        FormConfig {
            limit: 16384,
            ehandler: None,
...
#[cfg_attr(test, ::mutagen::mutate)] impl<U> UrlEncoded<U> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<U> Future for UrlEncoded<U>
where
