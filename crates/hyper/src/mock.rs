...
#[cfg(feature = "runtime")]
#[cfg_attr(test, ::mutagen::mutate)] impl Duplex {
...
#[cfg(feature = "runtime")]
#[cfg_attr(test, ::mutagen::mutate)] impl Read for Duplex {
...
#[cfg(feature = "runtime")]
#[cfg_attr(test, ::mutagen::mutate)] impl Write for Duplex {
...
#[cfg(feature = "runtime")]
#[cfg_attr(test, ::mutagen::mutate)] impl AsyncRead for Duplex {
}

#[cfg(feature = "runtime")]
#[cfg_attr(test, ::mutagen::mutate)] impl AsyncWrite for Duplex {
...
#[cfg(feature = "runtime")]
#[cfg_attr(test, ::mutagen::mutate)] impl DuplexHandle {
...
#[cfg(feature = "runtime")]
#[cfg_attr(test, ::mutagen::mutate)] impl Drop for DuplexHandle {
    fn drop(&mut self) {
...
#[cfg(feature = "runtime")]
#[cfg_attr(test, ::mutagen::mutate)] impl MockConnector {
...
#[cfg(feature = "runtime")]
#[cfg_attr(test, ::mutagen::mutate)] impl Connect for MockConnector {
...
#[cfg(feature = "runtime")]
#[cfg_attr(test, ::mutagen::mutate)] impl Drop for MockedConnections {
    fn drop(&mut self) {
        if !::std::thread::panicking() {
