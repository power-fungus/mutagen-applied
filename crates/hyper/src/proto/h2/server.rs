...
// TODO: fix me
#[cfg_attr(test, ::mutagen::mutate)] impl<T, S: Service<Body>, B: Payload, E> Unpin for Server<T, S, B, E> {}
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T, S, B, E> Server<T, S, B, E>
where
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T, S, B, E> Future for Server<T, S, B, E>
where
    T: AsyncRead + AsyncWrite + Unpin,
    S: Service<Body, ResBody=B>,
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T, B> Serving<T, B>
where
    T: AsyncRead + AsyncWrite + Unpin,
    B: Payload,
    B::Data: Unpin,
...
#[cfg_attr(test, ::mutagen::mutate)] impl<F, B> H2Stream<F, B>
where
...
#[cfg_attr(test, ::mutagen::mutate)] impl<F, B, E> H2Stream<F, B>
where
...
#[cfg_attr(test, ::mutagen::mutate)] impl<F, B, E> Future for H2Stream<F, B>
where
    F: Future<Output = Result<Response<B>, E>>,
    B: Payload + Unpin,
    B::Data: Unpin,
