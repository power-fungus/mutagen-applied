...
#[cfg_attr(test, ::mutagen::mutate)] fn strip_connection_headers(headers: &mut HeaderMap, is_request: bool) {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<S> PipeToSendStream<S>
where
    S: Payload,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<S> Future for PipeToSendStream<S>
where
    S: Payload + Unpin,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<B: Buf> Buf for SendBuf<B> {
    #[inline]
