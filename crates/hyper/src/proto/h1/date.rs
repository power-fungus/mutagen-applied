...
#[cfg_attr(test, ::mutagen::mutate)] pub fn extend(dst: &mut Vec<u8>) {
    CACHED.with(|cache| {
        dst.extend_from_slice(cache.borrow().buffer());
    })
}

#[cfg_attr(test, ::mutagen::mutate)] pub fn update() {
    CACHED.with(|cache| {
...
#[cfg_attr(test, ::mutagen::mutate)] impl CachedDate {
    fn new() -> Self {
...
#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Write for CachedDate {
...
#[test]
#[cfg_attr(test, ::mutagen::mutate)] fn test_date_len() {
