...
#[cfg_attr(test, ::mutagen::mutate)] impl Decoder {
    // constructors
...
#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Debug for Decoder {
...
#[cfg_attr(test, ::mutagen::mutate)] impl ChunkedState {
...
#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Display for IncompleteBody {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.description())
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl StdError for IncompleteBody {
