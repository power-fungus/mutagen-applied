...
#[cfg_attr(test, ::mutagen::mutate)] impl Http1Transaction for Server {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Server {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Http1Transaction for Client {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Client {
...
#[cfg_attr(test, ::mutagen::mutate)] fn set_content_length(headers: &mut HeaderMap, len: u64) -> Encoder {
...
#[cfg_attr(test, ::mutagen::mutate)] fn record_header_indices(
    bytes: &[u8],
...
// space.
#[cfg_attr(test, ::mutagen::mutate)] fn title_case(dst: &mut Vec<u8>, name: &[u8]) {
...
#[cfg_attr(test, ::mutagen::mutate)] fn write_headers_title_case(headers: &HeaderMap, dst: &mut Vec<u8>) {
...
#[cfg_attr(test, ::mutagen::mutate)] fn write_headers(headers: &HeaderMap, dst: &mut Vec<u8>) {
    for (name, value) in headers {
        extend(dst, name.as_str().as_bytes());
        extend(dst, b": ");
        extend(dst, value.as_bytes());
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a> fmt::Write for FastWrite<'a> {
    #[inline]
...
#[inline]
#[cfg_attr(test, ::mutagen::mutate)] fn extend(dst: &mut Vec<u8>, data: &[u8]) {
