...
#[cfg_attr(test, ::mutagen::mutate)] impl<T, B> fmt::Debug for Buffered<T, B>
where
    B: Buf,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T, B> Buffered<T, B>
where
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: Unpin, B> Unpin for Buffered<T, B> {}
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T, B> MemRead for Buffered<T, B>
where
    T: AsyncRead + AsyncWrite + Unpin,
    B: Buf,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl ReadStrategy {
...
#[cfg_attr(test, ::mutagen::mutate)] fn incr_power_of_two(n: usize) -> usize {
    n.saturating_mul(2)
}

#[cfg_attr(test, ::mutagen::mutate)] fn prev_power_of_two(n: usize) -> usize {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Default for ReadStrategy {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: AsRef<[u8]>> Cursor<T> {
    #[inline]
...
#[cfg_attr(test, ::mutagen::mutate)] impl Cursor<Vec<u8>> {
    fn reset(&mut self) {
        self.pos = 0;
        self.bytes.clear();
    }
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: AsRef<[u8]>> fmt::Debug for Cursor<T> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: AsRef<[u8]>> Buf for Cursor<T> {
    #[inline]
...
#[cfg_attr(test, ::mutagen::mutate)] impl<B> WriteBuf<B> {
    fn new() -> WriteBuf<B> {
        WriteBuf {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<B: Buf> fmt::Debug for WriteBuf<B> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<B: Buf> Buf for WriteBuf<B> {
    #[inline]
    fn remaining(&self) -> usize {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a, B: Buf> WriteBufAuto<'a, B> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a, B: Buf> Buf for WriteBufAuto<'a, B> {
    #[inline]
    fn remaining(&self) -> usize {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a, B: Buf + 'a> Drop for WriteBufAuto<'a, B> {
    fn drop(&mut self) {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> BufDeque<T> {
    fn new() -> BufDeque<T> {
        BufDeque {
            bufs: VecDeque::new(),
        }
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: Buf> Buf for BufDeque<T> {
    #[inline]
    fn remaining(&self) -> usize {
        self.bufs.iter()
