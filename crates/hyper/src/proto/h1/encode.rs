...
#[cfg_attr(test, ::mutagen::mutate)] impl Encoder {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<B> Buf for EncodedBuf<B>
where
    B: Buf,
{
    #[inline]
...
#[cfg_attr(test, ::mutagen::mutate)] impl ChunkSize {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Buf for ChunkSize {
    #[inline]
    fn remaining(&self) -> usize {
...
#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Debug for ChunkSize {
...
#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Write for ChunkSize {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<B: Buf> From<B> for EncodedBuf<B> {
    fn from(buf: B) -> Self {
        EncodedBuf {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<B: Buf> From<Take<B>> for EncodedBuf<B> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<B: Buf> From<Chain<Chain<ChunkSize, B>, StaticBuf>> for EncodedBuf<B> {
