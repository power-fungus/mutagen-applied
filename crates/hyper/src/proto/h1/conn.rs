...
#[cfg_attr(test, ::mutagen::mutate)] impl<I, B, T> Conn<I, B, T>
...
#[cfg_attr(test, ::mutagen::mutate)] impl<I, B: Buf, T> fmt::Debug for Conn<I, B, T> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<I: Unpin, B, T> Unpin for Conn<I, B, T> {}
...
#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Debug for Writing {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match *self {
...
#[cfg_attr(test, ::mutagen::mutate)] impl ::std::ops::BitAndAssign<bool> for KA {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Default for KA {
    fn default() -> KA {
        KA::Busy
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl KA {
    fn idle(&mut self) {
        *self = KA::Idle;
    }
