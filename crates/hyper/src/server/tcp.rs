...
#[cfg_attr(test, ::mutagen::mutate)] impl AddrIncoming {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Accept for AddrIncoming {
...
#[cfg_attr(test, ::mutagen::mutate)] fn is_connection_error(e: &io::Error) -> bool {
    match e.kind() {
...
#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Debug for AddrIncoming {
