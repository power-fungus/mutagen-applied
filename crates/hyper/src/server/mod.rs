...
#[cfg_attr(test, ::mutagen::mutate)] impl<I> Server<I, ()> {
...
#[cfg(feature = "tcp")]
#[cfg_attr(test, ::mutagen::mutate)] impl Server<AddrIncoming, ()> {
...
#[cfg(feature = "tcp")]
#[cfg_attr(test, ::mutagen::mutate)] impl<S> Server<AddrIncoming, S> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<I, IO, IE, S, E, B> Server<I, S, E>
where
...
#[cfg_attr(test, ::mutagen::mutate)] impl<I, IO, IE, S, B, E> Future for Server<I, S, E>
where
    I: Accept<Conn=IO, Error=IE>,
    IE: Into<Box<dyn StdError + Send + Sync>>,
    IO: AsyncRead + AsyncWrite + Unpin + Send + 'static,
...
#[cfg_attr(test, ::mutagen::mutate)] impl<I: fmt::Debug, S: fmt::Debug> fmt::Debug for Server<I, S> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<I, E> Builder<I, E> {
...
#[cfg(feature = "tcp")]
#[cfg_attr(test, ::mutagen::mutate)] impl<E> Builder<AddrIncoming, E> {
