...
#[cfg_attr(test, ::mutagen::mutate)] pub fn channel() -> (Signal, Watch) {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Signal {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Future for Draining {
    type Output = ();
...
#[cfg_attr(test, ::mutagen::mutate)] impl Watch {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<F, FN> Future for Watching<F, FN>
where
    F: Future,
    FN: FnOnce(Pin<&mut F>),
{
