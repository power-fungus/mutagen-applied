...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> Rewind<T> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> AsyncRead for Rewind<T>
where
    T: AsyncRead + Unpin,
{
    #[inline]
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> AsyncWrite for Rewind<T>
where
    T: AsyncWrite + Unpin,
{
