...
#[cfg_attr(test, ::mutagen::mutate)] impl Error {
...
#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Debug for Error {
...
#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Display for Error {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        if let Some(ref cause) = self.inner.cause {
...
#[cfg_attr(test, ::mutagen::mutate)] impl StdError for Error {
...
#[doc(hidden)]
#[cfg_attr(test, ::mutagen::mutate)] impl From<Parse> for Error {
    fn from(err: Parse) -> Error {
        Error::new(Kind::Parse(err))
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl From<httparse::Error> for Parse {
...
#[cfg_attr(test, ::mutagen::mutate)] impl From<http::method::InvalidMethod> for Parse {
    fn from(_: http::method::InvalidMethod) -> Parse {
        Parse::Method
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl From<http::status::InvalidStatusCode> for Parse {
    fn from(_: http::status::InvalidStatusCode) -> Parse {
        Parse::Status
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl From<http::uri::InvalidUri> for Parse {
    fn from(_: http::uri::InvalidUri) -> Parse {
        Parse::Uri
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl From<http::uri::InvalidUriBytes> for Parse {
    fn from(_: http::uri::InvalidUriBytes) -> Parse {
        Parse::Uri
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl From<http::uri::InvalidUriParts> for Parse {
...
#[doc(hidden)]
#[cfg_attr(test, ::mutagen::mutate)] impl AssertSendSync for Error {}
