...
#[cfg_attr(test, ::mutagen::mutate)] impl<B> SendRequest<B>
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<B> Service<Request<B>> for SendRequest<B>
where
    B: Payload + 'static, {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<B> fmt::Debug for SendRequest<B> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<B> Http2SendRequest<B> {
    pub(super) fn is_ready(&self) -> bool {
        self.dispatch.is_ready()
    }
...
#[cfg_attr(test, ::mutagen::mutate)] impl<B> fmt::Debug for Http2SendRequest<B> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<B> Clone for Http2SendRequest<B> {
    fn clone(&self) -> Self {
        Http2SendRequest {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T, B> Connection<T, B>
where
    T: AsyncRead + AsyncWrite + Unpin + Send + 'static,
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T, B> Future for Connection<T, B>
where
    T: AsyncRead + AsyncWrite + Unpin + Send + 'static,
    B: Payload + Unpin + 'static,
    B::Data: Unpin,
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T, B> fmt::Debug for Connection<T, B>
where
...
#[doc(hidden)]
#[cfg_attr(test, ::mutagen::mutate)] impl<B: Send> AssertSendSync for SendRequest<B> {}

#[doc(hidden)]
#[cfg_attr(test, ::mutagen::mutate)] impl<T: Send, B: Send> AssertSend for Connection<T, B>
where
    T: AsyncRead + AsyncWrite + Send + 'static,
    B: Payload + 'static,
{}
...
#[doc(hidden)]
#[cfg_attr(test, ::mutagen::mutate)] impl<T: Send + Sync, B: Send + Sync> AssertSendSync for Connection<T, B>
where
    T: AsyncRead + AsyncWrite + Send + 'static,
    B: Payload + 'static,
...
#[doc(hidden)]
#[cfg_attr(test, ::mutagen::mutate)] impl AssertSendSync for Builder {}

#[doc(hidden)]
#[cfg_attr(test, ::mutagen::mutate)] impl AssertSend for ResponseFuture {}
