...
#[cfg_attr(test, ::mutagen::mutate)] impl HttpConnector {
...
#[cfg(feature = "runtime")]
#[cfg_attr(test, ::mutagen::mutate)] impl HttpConnector<TokioThreadpoolGaiResolver> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<R> HttpConnector<R> {
    /// Construct a new HttpConnector.
    ///
...
#[cfg_attr(test, ::mutagen::mutate)] impl<R: fmt::Debug> fmt::Debug for HttpConnector<R> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<R> Connect for HttpConnector<R>
where
...
#[cfg_attr(test, ::mutagen::mutate)] impl<R> tower_service::Service<Uri> for HttpConnector<R>
where
...
#[cfg_attr(test, ::mutagen::mutate)] impl HttpInfo {
...
#[inline]
#[cfg_attr(test, ::mutagen::mutate)] fn invalid_url<R: Resolve>(err: InvalidUrl, handle: &Option<Handle>) -> HttpConnecting<R> {
    HttpConnecting {
...
#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Display for InvalidUrl {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.description())
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl StdError for InvalidUrl {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<R: Resolve> Future for HttpConnecting<R>
where
    R::Future: Unpin,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<R: Resolve + fmt::Debug> fmt::Debug for HttpConnecting<R> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
#[cfg_attr(test, ::mutagen::mutate)] impl ConnectingTcp {
    fn new(
        local_addr: Option<IpAddr>,
...
#[cfg_attr(test, ::mutagen::mutate)] impl ConnectingTcpRemote {
...
#[cfg_attr(test, ::mutagen::mutate)] fn connect(
    addr: &SocketAddr,
    local_addr: &Option<IpAddr>,
    handle: &Option<Handle>,
    reuse_address: bool,
