...
#[cfg_attr(test, ::mutagen::mutate)] impl Name {
...
#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Debug for Name {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        fmt::Debug::fmt(&self.host, f)
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Display for Name {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        fmt::Display::fmt(&self.host, f)
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl FromStr for Name {
...
#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Display for InvalidNameError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str("Not a valid domain name")
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl Error for InvalidNameError {}


#[cfg_attr(test, ::mutagen::mutate)] impl GaiResolver {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Resolve for GaiResolver {
    type Addrs = GaiAddrs;
...
#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Debug for GaiResolver {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.pad("GaiResolver")
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl Future for GaiFuture {
...
#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Debug for GaiFuture {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.pad("GaiFuture")
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl Iterator for GaiAddrs {
    type Item = IpAddr;
...
#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Debug for GaiAddrs {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.pad("GaiAddrs")
    }
}
...
#[cfg_attr(test, ::mutagen::mutate)] impl GaiBlocking {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Future for GaiBlocking {
    type Output = ();
...
#[cfg_attr(test, ::mutagen::mutate)] impl IpAddrs {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Iterator for IpAddrs {
...
#[cfg(feature = "runtime")]
#[cfg_attr(test, ::mutagen::mutate)] impl TokioThreadpoolGaiResolver {
...
#[cfg(feature = "runtime")]
#[cfg_attr(test, ::mutagen::mutate)] impl Resolve for TokioThreadpoolGaiResolver {
    type Addrs = GaiAddrs;
...
#[cfg(feature = "runtime")]
#[cfg_attr(test, ::mutagen::mutate)] impl Future for TokioThreadpoolGaiFuture {
    type Output = Result<GaiAddrs, io::Error>;
