...
#[cfg_attr(test, ::mutagen::mutate)] pub fn channel<T, U>() -> (Sender<T, U>, Receiver<T, U>) {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T, U> Sender<T, U> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T, U> UnboundedSender<T, U> {
    pub fn is_ready(&self) -> bool {
        !self.giver.is_canceled()
    }
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T, U> Clone for UnboundedSender<T, U> {
    fn clone(&self) -> Self {
        UnboundedSender {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T, U> Receiver<T, U> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T, U> Drop for Receiver<T, U> {
    fn drop(&mut self) {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T, U> Drop for Envelope<T, U> {
    fn drop(&mut self) {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T, U> Callback<T, U> {
