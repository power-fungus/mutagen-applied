...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> Pool<T> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: Poolable> Pool<T> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a, T: Poolable + 'a> IdlePopper<'a, T> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: Poolable> PoolInner<T> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> PoolInner<T> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> Clone for Pool<T> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: Poolable> Pooled<T> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: Poolable> Deref for Pooled<T> {
    type Target = T;
    fn deref(&self) -> &T {
        self.as_ref()
    }
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: Poolable> DerefMut for Pooled<T> {
    fn deref_mut(&mut self) -> &mut T {
        self.as_mut()
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl<T: Poolable> Drop for Pooled<T> {
    fn drop(&mut self) {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: Poolable> fmt::Debug for Pooled<T> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: Poolable> Checkout<T> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: Poolable> Future for Checkout<T> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> Drop for Checkout<T> {
    fn drop(&mut self) {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: Poolable> Connecting<T> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: Poolable> Drop for Connecting<T> {
    fn drop(&mut self) {
        if let Some(pool) = self.pool.upgrade() {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Expiration {
...
#[cfg(feature = "runtime")]
#[cfg_attr(test, ::mutagen::mutate)] impl<T: Poolable + 'static> Future for IdleTask<T> {
    type Output = ();
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> WeakOpt<T> {
    fn none() -> Self {
        WeakOpt(None)
    }
