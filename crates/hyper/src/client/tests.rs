...
#[test]
#[cfg_attr(test, ::mutagen::mutate)] fn retryable_request() {
...
#[test]
#[cfg_attr(test, ::mutagen::mutate)] fn conn_reset_after_write() {
    let _ = pretty_env_logger::try_init();
...
#[test]
#[cfg_attr(test, ::mutagen::mutate)] fn checkout_win_allows_connect_future_to_be_pooled() {
    let _ = pretty_env_logger::try_init();
...
#[cfg(feature = "nightly")]
#[bench]
#[cfg_attr(test, ::mutagen::mutate)] fn bench_http1_get_0b(b: &mut test::Bencher) {
    let _ = pretty_env_logger::try_init();
...
#[cfg(feature = "nightly")]
#[bench]
#[cfg_attr(test, ::mutagen::mutate)] fn bench_http1_get_10b(b: &mut test::Bencher) {
    let _ = pretty_env_logger::try_init();
