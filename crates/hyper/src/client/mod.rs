...
#[cfg(feature = "tcp")]
#[cfg_attr(test, ::mutagen::mutate)] impl Client<HttpConnector, Body> {
...
#[cfg(feature = "tcp")]
#[cfg_attr(test, ::mutagen::mutate)] impl Default for Client<HttpConnector, Body> {
    fn default() -> Client<HttpConnector, Body> {
        Client::new()
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl Client<(), Body> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<C, B> Client<C, B>
...
#[cfg_attr(test, ::mutagen::mutate)] impl<C, B> Clone for Client<C, B> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<C, B> fmt::Debug for Client<C, B> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl ResponseFuture {
...
#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Debug for ResponseFuture {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.pad("Future<Response>")
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl Future for ResponseFuture {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<B> PoolClient<B> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<B: Payload + 'static> PoolClient<B> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<B> Poolable for PoolClient<B>
where
    B: Send + 'static,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<B> ClientError<B> {
...
#[cfg_attr(test, ::mutagen::mutate)] fn origin_form(uri: &mut Uri) {
...
#[cfg_attr(test, ::mutagen::mutate)] fn absolute_form(uri: &mut Uri) {
...
#[cfg_attr(test, ::mutagen::mutate)] fn authority_form(uri: &mut Uri) {
...
#[cfg_attr(test, ::mutagen::mutate)] fn extract_domain(uri: &mut Uri, is_http_connect: bool) -> crate::Result<String> {
...
#[cfg_attr(test, ::mutagen::mutate)] fn set_scheme(uri: &mut Uri, scheme: Scheme) {
...
#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Debug for Builder {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
