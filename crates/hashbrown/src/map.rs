...
#[cfg(feature = "ahash")]
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V> HashMap<K, V, DefaultHashBuilder> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V, S> PartialEq for HashMap<K, V, S>
where
    K: Eq + Hash,
    V: PartialEq,
    S: BuildHasher,
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V, S> Eq for HashMap<K, V, S>
where
    K: Eq + Hash,
    V: Eq,
    S: BuildHasher,
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V, S> Debug for HashMap<K, V, S>
where
    K: Debug,
    V: Debug,
    S: BuildHasher,
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V, S> Default for HashMap<K, V, S>
where
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K, Q: ?Sized, V, S> Index<&Q> for HashMap<K, V, S>
where
    K: Eq + Hash + Borrow<Q>,
    Q: Eq + Hash,
    S: BuildHasher,
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V> Clone for Iter<'_, K, V> {
    #[cfg_attr(feature = "inline-more", inline)]
    fn clone(&self) -> Self {
        Iter {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K: Debug, V: Debug> fmt::Debug for Iter<'_, K, V> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V> IterMut<'_, K, V> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V> IntoIter<K, V> {
    /// Returns a iterator of references over the remaining items.
    #[cfg_attr(feature = "inline-more", inline)]
    pub(super) fn iter(&self) -> Iter<'_, K, V> {
        Iter {
...
// FIXME(#26925) Remove in favor of `#[derive(Clone)]`
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V> Clone for Keys<'_, K, V> {
    #[cfg_attr(feature = "inline-more", inline)]
    fn clone(&self) -> Self {
        Keys {
            inner: self.inner.clone(),
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K: Debug, V> fmt::Debug for Keys<'_, K, V> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_list().entries(self.clone()).finish()
    }
}
...
// FIXME(#26925) Remove in favor of `#[derive(Clone)]`
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V> Clone for Values<'_, K, V> {
    #[cfg_attr(feature = "inline-more", inline)]
    fn clone(&self) -> Self {
        Values {
            inner: self.inner.clone(),
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V: Debug> fmt::Debug for Values<'_, K, V> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_list().entries(self.clone()).finish()
    }
}
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V> Drain<'_, K, V> {
    /// Returns a iterator of references over the remaining items.
    #[cfg_attr(feature = "inline-more", inline)]
    pub(super) fn iter(&self) -> Iter<'_, K, V> {
        Iter {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a, K, V, S> RawEntryBuilderMut<'a, K, V, S>
where
    S: BuildHasher,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a, K, V, S> RawEntryBuilder<'a, K, V, S>
where
    S: BuildHasher,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a, K, V, S> RawEntryMut<'a, K, V, S> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a, K, V> RawOccupiedEntryMut<'a, K, V> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a, K, V, S> RawVacantEntryMut<'a, K, V, S> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V, S> Debug for RawEntryBuilderMut<'_, K, V, S> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("RawEntryBuilder").finish()
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl<K: Debug, V: Debug, S> Debug for RawEntryMut<'_, K, V, S> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match *self {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K: Debug, V: Debug> Debug for RawOccupiedEntryMut<'_, K, V> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V, S> Debug for RawVacantEntryMut<'_, K, V, S> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("RawVacantEntryMut").finish()
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl<K, V, S> Debug for RawEntryBuilder<'_, K, V, S> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("RawEntryBuilder").finish()
    }
}
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K: Debug, V: Debug, S> Debug for Entry<'_, K, V, S> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match *self {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K: Debug, V: Debug, S> Debug for OccupiedEntry<'_, K, V, S> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K: Debug, V, S> Debug for VacantEntry<'_, K, V, S> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_tuple("VacantEntry").field(self.key()).finish()
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl<'a, K, V, S> IntoIterator for &'a HashMap<K, V, S> {
    type Item = (&'a K, &'a V);
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a, K, V, S> IntoIterator for &'a mut HashMap<K, V, S> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V, S> IntoIterator for HashMap<K, V, S> {
    type Item = (K, V);
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V> ExactSizeIterator for Iter<'_, K, V> {
    #[cfg_attr(feature = "inline-more", inline)]
    fn len(&self) -> usize {
        self.inner.len()
    }
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V> FusedIterator for Iter<'_, K, V> {}
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V> ExactSizeIterator for IterMut<'_, K, V> {
    #[cfg_attr(feature = "inline-more", inline)]
    fn len(&self) -> usize {
        self.inner.len()
    }
}
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V> FusedIterator for IterMut<'_, K, V> {}

#[cfg_attr(test, ::mutagen::mutate)] impl<K, V> fmt::Debug for IterMut<'_, K, V>
where
    K: fmt::Debug,
    V: fmt::Debug,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V> FusedIterator for IntoIter<K, V> {}

#[cfg_attr(test, ::mutagen::mutate)] impl<K: Debug, V: Debug> fmt::Debug for IntoIter<K, V> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_list().entries(self.iter()).finish()
    }
}
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V> ExactSizeIterator for Keys<'_, K, V> {
    #[cfg_attr(feature = "inline-more", inline)]
    fn len(&self) -> usize {
        self.inner.len()
    }
}
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V> FusedIterator for Keys<'_, K, V> {}
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V> ExactSizeIterator for Values<'_, K, V> {
    #[cfg_attr(feature = "inline-more", inline)]
    fn len(&self) -> usize {
        self.inner.len()
    }
}
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V> FusedIterator for Values<'_, K, V> {}
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V> ExactSizeIterator for ValuesMut<'_, K, V> {
    #[cfg_attr(feature = "inline-more", inline)]
    fn len(&self) -> usize {
        self.inner.len()
    }
}
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V> FusedIterator for ValuesMut<'_, K, V> {}

#[cfg_attr(test, ::mutagen::mutate)] impl<K, V> fmt::Debug for ValuesMut<'_, K, V>
where
    K: fmt::Debug,
    V: fmt::Debug,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V> ExactSizeIterator for Drain<'_, K, V> {
    #[cfg_attr(feature = "inline-more", inline)]
    fn len(&self) -> usize {
        self.inner.len()
    }
}
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V> FusedIterator for Drain<'_, K, V> {}

#[cfg_attr(test, ::mutagen::mutate)] impl<K, V> fmt::Debug for Drain<'_, K, V>
where
    K: fmt::Debug,
    V: fmt::Debug,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a, K, V, S> Entry<'a, K, V, S> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a, K, V: Default, S> Entry<'a, K, V, S> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a, K, V, S> OccupiedEntry<'a, K, V, S> {
    /// Gets a reference to the key in the entry.
    ///
    /// # Examples
    ///
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a, K, V, S> VacantEntry<'a, K, V, S> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V, S> FromIterator<(K, V)> for HashMap<K, V, S>
where
    K: Eq + Hash,
    S: BuildHasher + Default,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K, V, S> Extend<(K, V)> for HashMap<K, V, S>
where
    K: Eq + Hash,
    S: BuildHasher,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a, K, V, S> Extend<(&'a K, &'a V)> for HashMap<K, V, S>
where
    K: Eq + Hash + Copy,
    V: Copy,
    S: BuildHasher,
...
#[allow(dead_code)]
#[cfg_attr(test, ::mutagen::mutate)] fn assert_covariance() {
