...
#[cfg_attr(test, ::mutagen::mutate)] impl BitMask {
...
#[cfg_attr(test, ::mutagen::mutate)] impl IntoIterator for BitMask {
    type Item = usize;
...
#[cfg_attr(test, ::mutagen::mutate)] impl Iterator for BitMaskIter {
    type Item = usize;
