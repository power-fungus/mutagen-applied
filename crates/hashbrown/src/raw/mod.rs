...
#[inline]
#[cfg_attr(test, ::mutagen::mutate)] fn likely(b: bool) -> bool {
    b
}
#[cfg(not(feature = "nightly"))]
#[inline]
#[cfg_attr(test, ::mutagen::mutate)] fn unlikely(b: bool) -> bool {
    b
}
...
#[cfg_attr(test, ::mutagen::mutate)] impl Fallibility {
...
#[inline]
#[cfg_attr(test, ::mutagen::mutate)] fn is_full(ctrl: u8) -> bool {
    ctrl & 0x80 == 0
}

/// Checks whether a control byte represents a special value (top bit is set).
#[inline]
#[cfg_attr(test, ::mutagen::mutate)] fn is_special(ctrl: u8) -> bool {
    ctrl & 0x80 != 0
}

/// Checks whether a special control value is EMPTY (just check 1 bit).
#[inline]
#[cfg_attr(test, ::mutagen::mutate)] fn special_is_empty(ctrl: u8) -> bool {
...
#[cfg_attr(test, ::mutagen::mutate)] fn h1(hash: u64) -> usize {
...
#[inline]
#[allow(clippy::cast_possible_truncation)]
#[cfg_attr(test, ::mutagen::mutate)] fn h2(hash: u64) -> u8 {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Iterator for ProbeSeq {
    type Item = usize;
...
#[cfg_attr(test, ::mutagen::mutate)] fn capacity_to_buckets(cap: usize) -> Option<usize> {
...
#[cfg_attr(feature = "inline-more", inline)]
#[cfg_attr(test, ::mutagen::mutate)] fn bucket_mask_to_capacity(bucket_mask: usize) -> usize {
    if bucket_mask < 8 {
...
#[cfg_attr(feature = "inline-more", inline)]
#[cfg(feature = "nightly")]
#[cfg_attr(test, ::mutagen::mutate)] fn calculate_layout<T>(buckets: usize) -> Option<(Layout, usize)> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> Clone for Bucket<T> {
    #[cfg_attr(feature = "inline-more", inline)]
    fn clone(&self) -> Self {
        Self { ptr: self.ptr }
    }
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> Bucket<T> {
    #[cfg_attr(feature = "inline-more", inline)]
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> RawTable<T> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: Clone> Clone for RawTable<T> {
    fn clone(&self) -> Self {
        if self.is_empty_singleton() {
            Self::new()
        } else {
...
#[cfg(not(feature = "nightly"))]
#[cfg_attr(test, ::mutagen::mutate)] impl<T> Drop for RawTable<T> {
    #[cfg_attr(feature = "inline-more", inline)]
    fn drop(&mut self) {
        if !self.is_empty_singleton() {
            unsafe {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> IntoIterator for RawTable<T> {
    type Item = T;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> RawIterRange<T> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> Clone for RawIterRange<T> {
    #[cfg_attr(feature = "inline-more", inline)]
    fn clone(&self) -> Self {
        Self {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> Iterator for RawIterRange<T> {
    type Item = Bucket<T>;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> FusedIterator for RawIterRange<T> {}
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> Clone for RawIter<T> {
    #[cfg_attr(feature = "inline-more", inline)]
    fn clone(&self) -> Self {
        Self {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> Iterator for RawIter<T> {
    type Item = Bucket<T>;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> ExactSizeIterator for RawIter<T> {}
#[cfg_attr(test, ::mutagen::mutate)] impl<T> FusedIterator for RawIter<T> {}
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> RawIntoIter<T> {
    #[cfg_attr(feature = "inline-more", inline)]
...
#[cfg(not(feature = "nightly"))]
#[cfg_attr(test, ::mutagen::mutate)] impl<T> Drop for RawIntoIter<T> {
    #[cfg_attr(feature = "inline-more", inline)]
    fn drop(&mut self) {
        unsafe {
            // Drop all remaining elements
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> Iterator for RawIntoIter<T> {
    type Item = T;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> ExactSizeIterator for RawIntoIter<T> {}
#[cfg_attr(test, ::mutagen::mutate)] impl<T> FusedIterator for RawIntoIter<T> {}
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> RawDrain<'_, T> {
    #[cfg_attr(feature = "inline-more", inline)]
    pub fn iter(&self) -> RawIter<T> {
        self.iter.clone()
    }
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> Drop for RawDrain<'_, T> {
    #[cfg_attr(feature = "inline-more", inline)]
    fn drop(&mut self) {
        unsafe {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> Iterator for RawDrain<'_, T> {
    type Item = T;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> ExactSizeIterator for RawDrain<'_, T> {}
#[cfg_attr(test, ::mutagen::mutate)] impl<T> FusedIterator for RawDrain<'_, T> {}
