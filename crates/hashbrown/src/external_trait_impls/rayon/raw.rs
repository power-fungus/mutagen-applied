...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> ParallelIterator for RawParIter<T> {
    type Item = Bucket<T>;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> UnindexedProducer for ParIterProducer<T> {
    type Item = Bucket<T>;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: Send> ParallelIterator for RawIntoParIter<T> {
    type Item = T;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: Send> ParallelIterator for RawParDrain<'_, T> {
    type Item = T;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> Drop for RawParDrain<'_, T> {
    fn drop(&mut self) {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: Send> UnindexedProducer for ParDrainProducer<T> {
    type Item = T;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> Drop for ParDrainProducer<T> {
    #[cfg_attr(feature = "inline-more", inline)]
    fn drop(&mut self) {
