...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: Send, S: Send> ParallelIterator for IntoParIter<T, S> {
    type Item = T;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: Send, S: Send> ParallelIterator for ParDrain<'_, T, S> {
    type Item = T;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a, T: Sync, S: Sync> ParallelIterator for ParIter<'a, T, S> {
    type Item = &'a T;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a, T, S> ParallelIterator for ParSymmetricDifference<'a, T, S>
where
    T: Eq + Hash + Sync,
    S: BuildHasher + Sync,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a, T, S> ParallelIterator for ParUnion<'a, T, S>
where
    T: Eq + Hash + Sync,
    S: BuildHasher + Sync,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T: Send, S: Send> IntoParallelIterator for HashSet<T, S> {
    type Item = T;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a, T: Sync, S: Sync> IntoParallelIterator for &'a HashSet<T, S> {
    type Item = &'a T;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T, S> FromParallelIterator<T> for HashSet<T, S>
where
    T: Eq + Hash + Send,
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T, S> ParallelExtend<T> for HashSet<T, S>
where
    T: Eq + Hash + Send,
    S: BuildHasher,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a, T, S> ParallelExtend<&'a T> for HashSet<T, S>
where
...
#[cfg_attr(test, ::mutagen::mutate)] fn extend<T, S, I>(set: &mut HashSet<T, S>, par_iter: I)
where
    T: Eq + Hash,
    S: BuildHasher,
