...
#[cfg_attr(test, ::mutagen::mutate)] impl<K: Debug, V: Debug> Debug for RustcEntry<'_, K, V> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K: Debug, V: Debug> Debug for RustcOccupiedEntry<'_, K, V> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<K: Debug, V> Debug for RustcVacantEntry<'_, K, V> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_tuple("VacantEntry").field(self.key()).finish()
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl<'a, K, V> RustcEntry<'a, K, V> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a, K, V: Default> RustcEntry<'a, K, V> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a, K, V> RustcOccupiedEntry<'a, K, V> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a, K, V> RustcVacantEntry<'a, K, V> {
