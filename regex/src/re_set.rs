...
#[cfg_attr(test, ::mutagen::mutate)] impl RegexSet {
...
#[cfg_attr(test, ::mutagen::mutate)] impl SetMatches {
...
#[cfg_attr(test, ::mutagen::mutate)] impl IntoIterator for SetMatches {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a> IntoIterator for &'a SetMatches {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Iterator for SetMatchesIntoIter {
    type Item = usize;
...
#[cfg_attr(test, ::mutagen::mutate)] impl DoubleEndedIterator for SetMatchesIntoIter {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a> Iterator for SetMatchesIter<'a> {
    type Item = usize;
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a> DoubleEndedIterator for SetMatchesIter<'a> {
    fn next_back(&mut self) -> Option<usize> {
        loop {
            match self.0.next_back() {
                None => return None,
...
#[doc(hidden)]
#[cfg_attr(test, ::mutagen::mutate)] impl From<Exec> for RegexSet {
    fn from(exec: Exec) -> Self {
        RegexSet(exec)
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Debug for RegexSet {
