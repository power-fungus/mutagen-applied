...
use crate::freqs::BYTE_FREQUENCIES;
...
#[cfg_attr(test, ::mutagen::mutate)] impl LiteralSearcher {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Matcher {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a> Iterator for LiteralIter<'a> {
    type Item = &'a [u8];
...
#[cfg_attr(test, ::mutagen::mutate)] impl SingleByteSet {
...
#[cfg_attr(test, ::mutagen::mutate)] impl FreqyPacked {
...
#[cfg_attr(test, ::mutagen::mutate)] fn char_len_lossy(bytes: &[u8]) -> usize {
...
#[cfg_attr(test, ::mutagen::mutate)] impl BoyerMooreSearch {
...
#[cfg_attr(test, ::mutagen::mutate)] fn freq_rank(b: u8) -> usize {
