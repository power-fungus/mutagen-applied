...
#[cfg_attr(test, ::mutagen::mutate)] implementation.)
*/
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> Result<T> {
...
#[cfg_attr(test, ::mutagen::mutate)] fn push_inst_ptr(data: &mut Vec<u8>, prev: &mut InstPtr, ip: InstPtr) {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a> Iterator for InstPtrs<'a> {
    type Item = usize;
...
#[cfg_attr(test, ::mutagen::mutate)] impl State {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Cache {
...
#[cfg_attr(test, ::mutagen::mutate)] impl CacheInner {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a> Fsm<'a> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl StateMap {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Transitions {
...
#[cfg_attr(test, ::mutagen::mutate)] impl StateFlags {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Byte {
    fn byte(b: u8) -> Self {
        Byte(b as u16)
    }
    fn eof() -> Self {
...
#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Debug for State {
...
#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Debug for Transitions {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a> fmt::Debug for TransitionsRow<'a> {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        let mut fmtd = f.debug_map();
...
#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Debug for StateFlags {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
...
#[cfg_attr(test, ::mutagen::mutate)] fn vb(b: usize) -> String {
...
#[cfg_attr(test, ::mutagen::mutate)] fn usize_to_u32(n: usize) -> u32 {
...
#[cfg_attr(test, ::mutagen::mutate)] fn show_state_ptr(si: StatePtr) -> String {
...
#[cfg_attr(test, ::mutagen::mutate)] fn write_vari32(data: &mut Vec<u8>, n: i32) {
...
/// https://developers.google.com/protocol-buffers/docs/encoding#varints
#[cfg_attr(test, ::mutagen::mutate)] fn read_vari32(data: &[u8]) -> (i32, usize) {
...
/// https://developers.google.com/protocol-buffers/docs/encoding#varints
#[cfg_attr(test, ::mutagen::mutate)] fn write_varu32(data: &mut Vec<u8>, mut n: u32) {
    while n >= 0b1000_0000 {
...
/// https://developers.google.com/protocol-buffers/docs/encoding#varints
#[cfg_attr(test, ::mutagen::mutate)] fn read_varu32(data: &[u8]) -> (u32, usize) {
    let mut n: u32 = 0;
    let mut shift: u32 = 0;
