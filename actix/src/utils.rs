...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> Condition<T>
where
    T: Clone,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> Default for Condition<T>
where
    T: Clone,
{
    fn default() -> Self {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<A> TimerFunc<A>
where
    A: Actor,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<A: Actor, F: FnOnce(&mut A, &mut A::Context) + 'static> TimerFuncBox<A> for F {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<A> ActorFuture for TimerFunc<A>
where
    A: Actor,
{
    type Item = ();
...
#[cfg_attr(test, ::mutagen::mutate)] impl<A: Actor> IntervalFunc<A> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<A: Actor, F: FnMut(&mut A, &mut A::Context) + 'static> IntervalFuncBox<A> for F {
    #[allow(clippy::boxed_local)]
...
#[cfg_attr(test, ::mutagen::mutate)] impl<A: Actor> ActorStream for IntervalFunc<A> {
    type Item = ();
    type Error = ();
    type Actor = A;
