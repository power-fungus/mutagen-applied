...
#[cfg_attr(test, ::mutagen::mutate)] impl Stream for Payload {
    type Item = Bytes;
...
/// }
/// ```
#[cfg_attr(test, ::mutagen::mutate)] impl FromRequest for Payload {
...
/// }
/// ```
#[cfg_attr(test, ::mutagen::mutate)] impl FromRequest for Bytes {
    type Config = PayloadConfig;
    type Error = Error;
    type Future =
...
/// }
/// ```
#[cfg_attr(test, ::mutagen::mutate)] impl FromRequest for String {
    type Config = PayloadConfig;
    type Error = Error;
    type Future = Either<
...
#[cfg_attr(test, ::mutagen::mutate)] impl PayloadConfig {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Default for PayloadConfig {
    fn default() -> Self {
        PayloadConfig {
            limit: 262_144,
            mimetype: None,
...
#[cfg_attr(test, ::mutagen::mutate)] impl HttpMessageBody {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Future for HttpMessageBody {
    type Item = Bytes;
    type Error = PayloadError;
