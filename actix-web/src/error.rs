...
#[cfg_attr(test, ::mutagen::mutate)] impl ResponseError for UrlGenerationError {}
...
#[cfg_attr(test, ::mutagen::mutate)] impl ResponseError for UrlencodedError {
...
#[cfg_attr(test, ::mutagen::mutate)] impl ResponseError for JsonPayloadError {
    fn error_response(&self) -> HttpResponse {
        match *self {
...
#[cfg_attr(test, ::mutagen::mutate)] impl ResponseError for PathError {
    fn error_response(&self) -> HttpResponse {
        match *self {
...
#[cfg_attr(test, ::mutagen::mutate)] impl ResponseError for QueryPayloadError {
    fn error_response(&self) -> HttpResponse {
        match *self {
...
#[cfg_attr(test, ::mutagen::mutate)] impl ResponseError for ReadlinesError {
    fn error_response(&self) -> HttpResponse {
        match *self {
