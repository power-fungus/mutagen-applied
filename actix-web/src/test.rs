...
#[cfg_attr(test, ::mutagen::mutate)] impl Inner {
    fn get_mut(&mut self) -> &mut SystemRunner {
        self.0.as_mut().unwrap()
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl Drop for Inner {
    fn drop(&mut self) {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Default for TestRequest {
...
#[cfg_attr(test, ::mutagen::mutate)] impl TestRequest {
