...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> ServiceFactoryWrapper<T> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> ServiceFactory for ServiceFactoryWrapper<T>
where
...
#[cfg_attr(test, ::mutagen::mutate)] impl ServiceRequest {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Resource<Url> for ServiceRequest {
    fn resource_path(&mut self) -> &mut Path<Url> {
        self.match_info_mut()
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl HttpMessage for ServiceRequest {
...
#[cfg_attr(test, ::mutagen::mutate)] impl fmt::Debug for ServiceRequest {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<B> ServiceResponse<B> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<B> Into<Response<B>> for ServiceResponse<B> {
    fn into(self) -> Response<B> {
        self.response
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl<B> IntoFuture for ServiceResponse<B> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<B: MessageBody> fmt::Debug for ServiceResponse<B> {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        let res = writeln!(
            f,
            "\nServiceResponse {:?} {}{}",
...
#[cfg_attr(test, ::mutagen::mutate)] impl WebService {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T> HttpServiceFactory for WebServiceImpl<T>
where
    T: NewService<
            Config = (),
            Request = ServiceRequest,
