...
#[cfg_attr(test, ::mutagen::mutate)] impl<B> Default for ErrorHandlers<B> {
    fn default() -> Self {
        ErrorHandlers {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<B> ErrorHandlers<B> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<S, B> Transform<S> for ErrorHandlers<B>
where
...
#[cfg_attr(test, ::mutagen::mutate)] impl<S, B> Service for ErrorHandlersMiddleware<S, B>
where
    S: Service<Request = ServiceRequest, Response = ServiceResponse<B>, Error = Error>,
    S::Future: 'static,
    B: 'static,
