...
#[cfg_attr(test, ::mutagen::mutate)] impl BodyEncoding for ResponseBuilder {
    fn encoding(&mut self, encoding: ContentEncoding) -> &mut Self {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<B> BodyEncoding for Response<B> {
    fn encoding(&mut self, encoding: ContentEncoding) -> &mut Self {
        self.extensions_mut().insert(Enc(encoding));
        self
    }
...
#[cfg_attr(test, ::mutagen::mutate)] impl Compress {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Default for Compress {
    fn default() -> Self {
        Compress::new(ContentEncoding::Auto)
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl<S, B> Transform<S> for Compress
where
    B: MessageBody,
...
#[cfg_attr(test, ::mutagen::mutate)] impl<S, B> Service for CompressMiddleware<S>
where
    B: MessageBody,
    S: Service<Request = ServiceRequest, Response = ServiceResponse<B>, Error = Error>,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<S, B> Future for CompressResponse<S, B>
where
    B: MessageBody,
    S: Service<Request = ServiceRequest, Response = ServiceResponse<B>, Error = Error>,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl Eq for AcceptEncoding {}

#[cfg_attr(test, ::mutagen::mutate)] impl Ord for AcceptEncoding {
...
#[cfg_attr(test, ::mutagen::mutate)] impl PartialOrd for AcceptEncoding {
    fn partial_cmp(&self, other: &AcceptEncoding) -> Option<cmp::Ordering> {
        Some(self.cmp(other))
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl PartialEq for AcceptEncoding {
    fn eq(&self, other: &AcceptEncoding) -> bool {
        self.quality == other.quality
    }
}

#[cfg_attr(test, ::mutagen::mutate)] impl AcceptEncoding {
