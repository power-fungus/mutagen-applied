...
#[cfg_attr(test, ::mutagen::mutate)] impl Logger {
    /// Create `Logger` middleware with the specified `format`.
...
#[cfg_attr(test, ::mutagen::mutate)] impl Default for Logger {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<S, B> Transform<S> for Logger
where
...
#[cfg_attr(test, ::mutagen::mutate)] impl<S, B> Service for LoggerMiddleware<S>
where
    S: Service<Request = ServiceRequest, Response = ServiceResponse<B>, Error = Error>,
    B: MessageBody,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<S, B> Future for LoggerResponse<S, B>
where
    B: MessageBody,
    S: Service<Request = ServiceRequest, Response = ServiceResponse<B>, Error = Error>,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<B> Drop for StreamLog<B> {
    fn drop(&mut self) {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<B: MessageBody> MessageBody for StreamLog<B> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Default for Format {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Format {
...
#[cfg_attr(test, ::mutagen::mutate)] impl FormatText {
    fn render(
        &self,
        fmt: &mut Formatter,
        size: usize,
...
#[cfg_attr(test, ::mutagen::mutate)] impl<'a> fmt::Display for FormatDisplay<'a> {
