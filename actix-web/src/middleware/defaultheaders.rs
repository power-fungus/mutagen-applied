...
#[cfg_attr(test, ::mutagen::mutate)] impl Default for DefaultHeaders {
    fn default() -> Self {
        DefaultHeaders {
            inner: Rc::new(Inner {
                ct: false,
...
#[cfg_attr(test, ::mutagen::mutate)] impl DefaultHeaders {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<S, B> Transform<S> for DefaultHeaders
where
...
#[cfg_attr(test, ::mutagen::mutate)] impl<S, B> Service for DefaultHeadersMiddleware<S>
where
    S: Service<Request = ServiceRequest, Response = ServiceResponse<B>, Error = Error>,
    S::Future: 'static,
{
