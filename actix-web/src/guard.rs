...
#[cfg_attr(test, ::mutagen::mutate)] impl<F> Guard for FnGuard<F>
where
    F: Fn(&RequestHead) -> bool,
{
...
#[cfg_attr(test, ::mutagen::mutate)] impl<F> Guard for F
where
    F: Fn(&RequestHead) -> bool,
{
    fn check(&self, head: &RequestHead) -> bool {
...
#[cfg_attr(test, ::mutagen::mutate)] impl AnyGuard {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Guard for AnyGuard {
...
#[cfg_attr(test, ::mutagen::mutate)] impl AllGuard {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Guard for AllGuard {
    fn check(&self, request: &RequestHead) -> bool {
        for p in &self.0 {
            if !p.check(request) {
                return false;
...
#[cfg_attr(test, ::mutagen::mutate)] impl Guard for NotGuard {
    fn check(&self, request: &RequestHead) -> bool {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Guard for MethodGuard {
    fn check(&self, request: &RequestHead) -> bool {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Guard for HeaderGuard {
    fn check(&self, req: &RequestHead) -> bool {
...
#[cfg_attr(test, ::mutagen::mutate)] fn get_host_uri(req: &RequestHead) -> Option<Uri> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl HostGuard {
...
#[cfg_attr(test, ::mutagen::mutate)] impl Guard for HostGuard {
    fn check(&self, req: &RequestHead) -> bool {
