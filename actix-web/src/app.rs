...
#[cfg_attr(test, ::mutagen::mutate)] impl App<AppEntry, Body> {
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T, B> App<T, B>
where
    B: MessageBody,
    T: NewService<
        Config = (),
...
#[cfg_attr(test, ::mutagen::mutate)] impl<T, B> IntoNewService<AppInit<T, B>> for App<T, B>
where
    B: MessageBody,
    T: NewService<
        Config = (),
