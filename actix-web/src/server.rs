...
#[cfg_attr(test, ::mutagen::mutate)] impl<F, I, S, B> HttpServer<F, I, S, B>
where
    F: Fn() -> I + Send + Clone + 'static,
    I: IntoNewService<S>,
    S: NewService<Config = ServerConfig, Request = Request>,
...
#[cfg_attr(test, ::mutagen::mutate)] fn create_tcp_listener(
    addr: net::SocketAddr,
    backlog: i32,
...
#[cfg_attr(test, ::mutagen::mutate)] fn openssl_acceptor(mut builder: SslAcceptorBuilder) -> io::Result<SslAcceptor> {
